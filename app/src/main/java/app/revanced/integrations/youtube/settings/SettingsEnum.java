...
public enum SettingsEnum {
    ...
    // Comments
    HIDE_CHANNEL_GUIDELINES("revanced_hide_channel_guidelines", BOOLEAN, FALSE),
    ...
    // Player Flyout Panel
    CHANGE_PLAYER_FLYOUT_PANEL_TOGGLE("revanced_change_player_flyout_panel_toggle", BOOLEAN, FALSE, true),
    ...
    HIDE_PLAYER_FLYOUT_PANEL_PREMIUM_CONTROLS("revanced_hide_player_flyout_panel_premium_controls", BOOLEAN, FALSE),
    ...
    // Quick Actions
    HIDE_QUICK_ACTIONS("revanced_hide_quick_actions", BOOLEAN, TRUE, true),
    ...
    ENABLE_COMPACT_CONTROLS_OVERLAY("revanced_enable_compact_controls_overlay", BOOLEAN, TRUE, true),
    FORCE_FULLSCREEN("revanced_force_fullscreen", BOOLEAN, TRUE, true),
    ...
    DISABLE_AUTO_CAPTIONS("revanced_disable_auto_captions", BOOLEAN, TRUE, true),
    ...
    ENABLE_TABLET_MINI_PLAYER("revanced_enable_tablet_mini_player", BOOLEAN, TRUE, true),
    ENABLE_WIDE_SEARCH_BAR("revanced_enable_wide_search_bar", BOOLEAN, TRUE, true),
    ...
    HIDE_ACCOUNT_MENU_FILTER_STRINGS("revanced_hide_account_menu_filter_strings", STRING, "Get YouTube Premium\nPurchases and memberships\nYour data in YouTube\nYouTube Music\nYouTube Kids\nYouTube Studio\n\nYour videos\nYour movies\nHelp & feedback", true,
    ...
    HIDE_LOAD_MORE_BUTTON("revanced_hide_load_more_button", BOOLEAN, FALSE, true),
    ...
    HIDE_TRENDING_SEARCHES("revanced_hide_trending_searches", BOOLEAN, FALSE),
    ...
    HIDE_ALBUM_CARDS("revanced_hide_album_card", BOOLEAN, FALSE),
    HIDE_CHIPS_SHELF("revanced_hide_chips_shelf", BOOLEAN, FALSE),
    HIDE_COMMUNITY_POSTS_HOME("revanced_hide_community_posts_home", BOOLEAN, FALSE),
    HIDE_COMMUNITY_POSTS_SUBSCRIPTIONS("revanced_hide_community_posts_subscriptions", BOOLEAN, FALSE),
    HIDE_COMMUNITY_POSTS_RELATED_VIDEO("revanced_hide_community_posts_related_video", BOOLEAN, FALSE),
    HIDE_EXPANDABLE_CHIP("revanced_hide_expandable_chip", BOOLEAN, FALSE),
    HIDE_FEED_SURVEY("revanced_hide_feed_survey", BOOLEAN, FALSE),
    HIDE_GRAY_DESCRIPTION("revanced_hide_gray_description", BOOLEAN, FALSE),
    HIDE_GRAY_SEPARATOR("revanced_hide_gray_separator", BOOLEAN, FALSE),
    HIDE_INFO_PANEL("revanced_hide_info_panel", BOOLEAN, FALSE),
    ...
    HIDE_TICKET_SHELF("revanced_hide_ticket_shelf", BOOLEAN, FALSE),
    ...
    // Channel Profile
    HIDE_BROWSE_STORE_BUTTON("revanced_hide_browse_store_button", BOOLEAN, FALSE),
    HIDE_CHANNEL_MEMBER_SHELF("revanced_hide_channel_member_shelf", BOOLEAN, FALSE),
    HIDE_CHANNEL_PROFILE_LINKS("revanced_hide_channel_profile_links", BOOLEAN, FALSE),
    HIDE_FOR_YOU_SHELF("revanced_hide_for_you_shelf", BOOLEAN, FALSE),
    HIDE_STORE_TAB("revanced_hide_store_tab", BOOLEAN, FALSE),
    ...
    HIDE_SHOPPING_LINKS("revanced_hide_shopping_links", BOOLEAN, FALSE),
    ...
    ENABLE_TABLET_LAYOUT("revanced_enable_tablet_layout", BOOLEAN, TRUE, true),
    ...
    HIDE_NOTIFICATIONS_BUTTON("revanced_hide_notifications_button", BOOLEAN, TRUE, true),
    ...
    HIDE_AUTOPLAY_BUTTON("revanced_hide_autoplay_button", BOOLEAN, FALSE, true),
    ...
    HIDE_SEEK_MESSAGE("revanced_hide_seek_message", BOOLEAN, TRUE, true),
    ...
    ENABLE_NEW_THUMBNAIL_PREVIEW("revanced_enable_new_thumbnail_preview", BOOLEAN, TRUE, true),
    ...
    // Shorts
    DISABLE_STARTUP_SHORTS_PLAYER("revanced_disable_startup_shorts_player", BOOLEAN, FALSE),
    ...
    HIDE_SHORTS_PLAYER_VIDEO_LINK_LABEL("revanced_hide_shorts_player_video_link_label", BOOLEAN, FALSE),
    HIDE_SHORTS_TOOLBAR_BANNER("revanced_hide_shorts_toolbar_banner", BOOLEAN, FALSE, true),
    HIDE_SHORTS_TOOLBAR_CAMERA_BUTTON("revanced_hide_shorts_toolbar_camera_button", BOOLEAN, TRUE, true),
    HIDE_SHORTS_TOOLBAR_MENU_BUTTON("revanced_hide_shorts_toolbar_menu_button", BOOLEAN, TRUE, true),
    ...
    SWIPE_OVERLAY_TIMEOUT("revanced_swipe_overlay_timeout", LONG, 500L, true,
            parents(ENABLE_SWIPE_BRIGHTNESS, ENABLE_SWIPE_VOLUME)),
    SWIPE_OVERLAY_RECT("revanced_swipe_overlay_rect", INTEGER, 20, true,
            parents(ENABLE_SWIPE_BRIGHTNESS, ENABLE_SWIPE_VOLUME)),
    ...
    RYD_DISLIKE_PERCENTAGE("ryd_dislike_percentage", BOOLEAN, TRUE, RETURN_YOUTUBE_DISLIKE, parents(RYD_ENABLED)),
