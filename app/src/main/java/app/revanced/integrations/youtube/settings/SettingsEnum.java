...
public enum SettingsEnum {
    ...
    // Feed Flyout Panel
    HIDE_FEED_FLYOUT_PANEL("revanced_hide_feed_flyout_panel", BOOLEAN, TRUE),
    ...
    HIDE_LIVE_CHAT_REPLAY("revanced_hide_live_chat_replay", BOOLEAN, TRUE),
    ...
    HIDE_ACCOUNT_MENU("revanced_hide_account_menu", BOOLEAN, TRUE),
    ...
    HIDE_COMMUNITY_POSTS_SUBSCRIPTIONS("revanced_hide_community_posts_subscriptions", BOOLEAN, TRUE),
    ...
    HIDE_SHORTS_PLAYER_COMMENTS_DISABLED_BUTTON("revanced_hide_shorts_player_comments_disabled_button", BOOLEAN, TRUE),
