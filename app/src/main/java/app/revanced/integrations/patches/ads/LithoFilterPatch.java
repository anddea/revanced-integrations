...
class ByteArrayFilterGroup extends FilterGroup<byte[]> {
    ...
    private void buildFailurePatterns() {
        LogHelper.printDebug(LithoFilterPatch.class, "Building failure array for: " + this);
...
abstract class Filter {
     ...
     * {@link #isFiltered(String, String, String, byte[], FilterGroupList, FilterGroup, int)},
...
public final class LithoFilterPatch {
    ...
    static {
        for (Filter filter : filters) {
            ...
            filterGroupLists(allValueSearchTree, filter, filter.allValueFilterGroups);
    ...
    private static final class LithoFilterParameters {
        ...
        LithoFilterParameters(String lithoPath, String lithoIdentifier, String allValues, byte[] bufferArray) {
            this.path = lithoPath;
