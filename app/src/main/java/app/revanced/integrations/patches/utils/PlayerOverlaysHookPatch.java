 ...
 *
 * @usedBy app.revanced.patches.youtube.misc.playeroverlay.patch.utils.PlayerOverlaysHookPatch
 * @smali Lapp/revanced/integrations/patches/utils/PlayerOverlaysHookPatch;
 */
