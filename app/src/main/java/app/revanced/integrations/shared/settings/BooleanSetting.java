...
public class BooleanSetting extends Setting<Boolean> {
    ...
    public BooleanSetting(@NonNull String key, @NonNull Boolean defaultValue, boolean rebootApp, boolean includeWithImportExport, @Nullable Availability availability) {
